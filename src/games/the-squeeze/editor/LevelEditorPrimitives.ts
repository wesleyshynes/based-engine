// Level Editor Primitives - Base drawing primitives and their handle configurations

import { drawBox, drawCircle, drawText, rotateDraw, drawPolygon, drawLine } from "../../../engine/libs/drawHelpers"
import { VertexPoint } from "./LevelEditorTypes"
import { HANDLE_COLOR, HANDLE_BORDER } from "./EditorConstants"

// ============================================================================
// Draw Context - passed to all draw functions
// ============================================================================
