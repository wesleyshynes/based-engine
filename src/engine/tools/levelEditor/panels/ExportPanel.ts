...
export interface ExportPanelCallbacks {
    getCurrentLevel: () => BaseEditorLevelData | null
...
export class ExportPanel extends EditorPanel {
    ...
    draw(): void {
        ...
        const constantsCode = this.callbacks.exportLevelAsCode(currentLevel)
        ...
        const classCode = this.callbacks.exportLevelClassCode(currentLevel)
